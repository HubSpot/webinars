...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SyncStage.guid'
        db.delete_column('webinars_syncstage', 'guid_id')

        # Adding field 'SyncStage.cms_form'
        db.add_column('webinars_syncstage', 'cms_form', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webinars.CmsForm'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SyncStage.guid'
        db.add_column('webinars_syncstage', 'guid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webinars.CmsForm'], null=True), keep_default=False)

        # Deleting field 'SyncStage.cms_form'
        db.delete_column('webinars_syncstage', 'cms_form_id')
