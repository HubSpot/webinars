...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EventForm.sync_start_at'
        db.delete_column('webinars_eventform', 'sync_start_at')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'EventForm.sync_start_at'
        db.add_column('webinars_eventform', 'sync_start_at', self.gf('sanetime.dj.SaneTimeField')(default=0), keep_default=False)
