...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.sync_lock'
        db.alter_column('webinars_account', 'sync_lock', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))

        # Changing field 'Event.sync_lock'
        db.alter_column('webinars_event', 'sync_lock', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))

        # Changing field 'Hub.sync_lock'
        db.alter_column('webinars_hub', 'sync_lock', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))


    def backwards(self, orm):
        
        # Changing field 'Account.sync_lock'
        db.alter_column('webinars_account', 'sync_lock', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Event.sync_lock'
        db.alter_column('webinars_event', 'sync_lock', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Hub.sync_lock'
        db.alter_column('webinars_hub', 'sync_lock', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
