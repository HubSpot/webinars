...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventSync.created_at'
        db.add_column('webinars_eventsync', 'created_at', self.gf('sanetime.dj.SaneTimeField')(default=0, blank=True), keep_default=False)

        # Changing field 'EventSync.started_at'
        db.alter_column('webinars_eventsync', 'started_at', self.gf('sanetime.dj.SaneTimeField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'EventSync.created_at'
        db.delete_column('webinars_eventsync', 'created_at')

        # User chose to not deal with backwards NULL issues for 'EventSync.started_at'
        raise RuntimeError("Cannot reverse this migration. 'EventSync.started_at' and its values cannot be restored.")
