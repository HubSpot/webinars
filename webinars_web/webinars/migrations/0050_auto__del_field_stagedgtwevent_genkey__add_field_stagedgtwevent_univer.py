...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StagedGTWEvent.genkey'
        db.delete_column('webinars_stagedgtwevent', 'genkey')

        # Adding field 'StagedGTWEvent.universal_key'
        db.add_column('webinars_stagedgtwevent', 'universal_key', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'StagedGTWEvent.genkey'
        raise RuntimeError("Cannot reverse this migration. 'StagedGTWEvent.genkey' and its values cannot be restored.")

        # Deleting field 'StagedGTWEvent.universal_key'
        db.delete_column('webinars_stagedgtwevent', 'universal_key')
