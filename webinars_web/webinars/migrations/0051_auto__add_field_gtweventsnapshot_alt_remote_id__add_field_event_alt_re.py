...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GTWEventSnapshot.alt_remote_id'
        db.add_column('webinars_gtweventsnapshot', 'alt_remote_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=128), keep_default=False)

        # Adding field 'Event.alt_remote_id'
        db.add_column('webinars_event', 'alt_remote_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True), keep_default=False)

        # Adding field 'StagedGTWEvent.key'
        db.add_column('webinars_stagedgtwevent', 'key', self.gf('django.db.models.fields.CharField')(default=None, max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GTWEventSnapshot.alt_remote_id'
        db.delete_column('webinars_gtweventsnapshot', 'alt_remote_id')

        # Deleting field 'Event.alt_remote_id'
        db.delete_column('webinars_event', 'alt_remote_id')

        # Deleting field 'StagedGTWEvent.key'
        db.delete_column('webinars_stagedgtwevent', 'key')
    ...
    models = {
        ...
        'webinars.gtweventsnapshot': {
            ...
            '_timezone': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webinars.Account']"}),
            'alt_remote_id': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '16383', 'null': 'True'}),
            'hashcode': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
