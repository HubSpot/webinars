...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hub.internal'
        db.add_column('webinars_hub', 'internal', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Hub.beta'
        db.add_column('webinars_hub', 'beta', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'AccountType.is_available'
        db.delete_column('webinars_accounttype', 'is_available')


    def backwards(self, orm):
        
        # Deleting field 'Hub.internal'
        db.delete_column('webinars_hub', 'internal')

        # Deleting field 'Hub.beta'
        db.delete_column('webinars_hub', 'beta')

        # Adding field 'AccountType.is_available'
        db.add_column('webinars_accounttype', 'is_available', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
