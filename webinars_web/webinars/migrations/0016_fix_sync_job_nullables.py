...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SyncJob.staged_at'
        db.alter_column('webinars_syncjob', 'staged_at', self.gf('sanetime.dj.SaneTimeField')(null=True))

        # Changing field 'SyncJob.completed_at'
        db.alter_column('webinars_syncjob', 'completed_at', self.gf('sanetime.dj.SaneTimeField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'SyncJob.staged_at'
        raise RuntimeError("Cannot reverse this migration. 'SyncJob.staged_at' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SyncJob.completed_at'
        raise RuntimeError("Cannot reverse this migration. 'SyncJob.completed_at' and its values cannot be restored.")
