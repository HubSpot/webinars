...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HubSync.error'
        db.add_column('webinars_hubsync', 'error', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True), keep_default=False)

        # Adding field 'EventSync.error'
        db.add_column('webinars_eventsync', 'error', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True), keep_default=False)

        # Adding field 'AccountSync.error'
        db.add_column('webinars_accountsync', 'error', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HubSync.error'
        db.delete_column('webinars_hubsync', 'error')

        # Deleting field 'EventSync.error'
        db.delete_column('webinars_eventsync', 'error')

        # Deleting field 'AccountSync.error'
        db.delete_column('webinars_accountsync', 'error')
