...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Registrant.conversion_event_guid'
        db.delete_column('webinars_registrant', 'conversion_event_guid')

        # Adding field 'Registrant.hashcode'
        db.add_column('webinars_registrant', 'hashcode', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Registrant.conversion_event_guid'
        db.add_column('webinars_registrant', 'conversion_event_guid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True), keep_default=False)

        # Deleting field 'Registrant.hashcode'
        db.delete_column('webinars_registrant', 'hashcode')
