...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventSyncShard.size'
        db.add_column('webinars_eventsyncshard', 'size', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'AccountSyncShard.size'
        db.add_column('webinars_accountsyncshard', 'size', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventSyncShard.size'
        db.delete_column('webinars_eventsyncshard', 'size')

        # Deleting field 'AccountSyncShard.size'
        db.delete_column('webinars_accountsyncshard', 'size')
