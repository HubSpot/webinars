...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SyncJob.auto'
        db.add_column('webinars_syncjob', 'auto', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SyncJob.auto'
        db.delete_column('webinars_syncjob', 'auto')
