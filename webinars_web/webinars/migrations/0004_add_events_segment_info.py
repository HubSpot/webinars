...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event._registered_criterium_guid'
        db.add_column('webinars_event', '_registered_criterium_guid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True), keep_default=False)

        # Adding field 'Event._attended_criterium_guid'
        db.add_column('webinars_event', '_attended_criterium_guid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True), keep_default=False)

        # Adding field 'Event._registered_saved_search_id'
        db.add_column('webinars_event', '_registered_saved_search_id', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Event._attended_saved_search_id'
        db.add_column('webinars_event', '_attended_saved_search_id', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Event._noshow_saved_search_id'
        db.add_column('webinars_event', '_noshow_saved_search_id', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event._registered_criterium_guid'
        db.delete_column('webinars_event', '_registered_criterium_guid')

        # Deleting field 'Event._attended_criterium_guid'
        db.delete_column('webinars_event', '_attended_criterium_guid')

        # Deleting field 'Event._registered_saved_search_id'
        db.delete_column('webinars_event', '_registered_saved_search_id')

        # Deleting field 'Event._attended_saved_search_id'
        db.delete_column('webinars_event', '_attended_saved_search_id')

        # Deleting field 'Event._noshow_saved_search_id'
        db.delete_column('webinars_event', '_noshow_saved_search_id')
