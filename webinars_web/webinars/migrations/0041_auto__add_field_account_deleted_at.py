...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.deleted_at'
        db.add_column('webinars_account', 'deleted_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.deleted_at'
        db.delete_column('webinars_account', 'deleted_at')
