...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StagedGTWEvent.key'
        db.alter_column('webinars_stagedgtwevent', 'key', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'StagedGTWEvent.key'
        raise RuntimeError("Cannot reverse this migration. 'StagedGTWEvent.key' and its values cannot be restored.")
