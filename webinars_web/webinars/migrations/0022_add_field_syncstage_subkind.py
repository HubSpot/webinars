...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SyncStage.subkind'
        db.add_column('webinars_syncstage', 'subkind', self.gf('django.db.models.fields.CharField')(max_length=16, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SyncStage.subkind'
        db.delete_column('webinars_syncstage', 'subkind')
