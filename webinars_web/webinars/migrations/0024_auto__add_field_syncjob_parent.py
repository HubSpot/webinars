...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SyncJob.parent'
        db.add_column('webinars_syncjob', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webinars.SyncJob'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SyncJob.parent'
        db.delete_column('webinars_syncjob', 'parent_id')
