...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('webinars_eventform', 'last_last_modified_at', self.gf('sanetime.dj.SaneTimeField')(default=0), keep_default=False)

        # Deleting field 'HubSpotEventSyncStage.last'
        db.delete_column('webinars_hubspoteventsyncstage', 'last')

        # Adding field 'HubSpotEventSyncStage.start_last_modified_at'
        db.add_column('webinars_hubspoteventsyncstage', 'start_last_modified_at', self.gf('sanetime.dj.SaneTimeField')(default=0), keep_default=False)

        # Adding field 'HubSpotEventSyncStage.cms_form'
        db.add_column('webinars_hubspoteventsyncstage', 'cms_form', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['webinars.CmsForm']), keep_default=False)

        # Adding field 'HubSpotEventSyncStage.finish_last_modified_at'
        db.add_column('webinars_hubspoteventsyncstage', 'finish_last_modified_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'HubSpotEventSyncStage.last'
        db.add_column('webinars_hubspoteventsyncstage', 'last', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'HubSpotEventSyncStage.start_last_modified_at'
        db.delete_column('webinars_hubspoteventsyncstage', 'start_last_modified_at')

        # Deleting field 'HubSpotEventSyncStage.cms_form'
        db.delete_column('webinars_hubspoteventsyncstage', 'cms_form_id')

        # Deleting field 'HubSpotEventSyncStage.finish_last_modified_at'
        db.delete_column('webinars_hubspoteventsyncstage', 'finish_last_modified_at')
