...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('webinars_account', 'prevent_unformed_lead_import', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.mothballed'
        db.add_column('webinars_event', 'mothballed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.unknowable_registrants'
        db.add_column('webinars_event', 'unknowable_registrants', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Account.email'
        raise RuntimeError("Cannot reverse this migration. 'Account.email' and its values cannot be restored.")
        ...
        # Deleting field 'Account.prevent_unformed_lead_import'
        db.delete_column('webinars_account', 'prevent_unformed_lead_import')

        # Deleting field 'Event.mothballed'
        db.delete_column('webinars_event', 'mothballed')

        # Deleting field 'Event.unknowable_registrants'
        db.delete_column('webinars_event', 'unknowable_registrants')
