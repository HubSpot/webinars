...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.avoid_sync'
        db.delete_column('webinars_event', 'avoid_sync')


    def backwards(self, orm):
        
        # Adding field 'Event.avoid_sync'
        db.add_column('webinars_event', 'avoid_sync', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
