...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GTWEventSnapshot.alt_remote_id'
        db.alter_column('webinars_gtweventsnapshot', 'alt_remote_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'GTWEventSnapshot.alt_remote_id'
        raise RuntimeError("Cannot reverse this migration. 'GTWEventSnapshot.alt_remote_id' and its values cannot be restored.")
