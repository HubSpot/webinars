...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webinars_event', 'description', self.gf('django.db.models.fields.CharField')(max_length=16383, null=True))


    def backwards(self, orm):
        
        # Changing field 'Event.description'
        db.alter_column('webinars_event', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=16383))
