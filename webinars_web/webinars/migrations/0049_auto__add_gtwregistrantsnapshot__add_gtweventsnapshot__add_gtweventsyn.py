...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GTWRegistrantSnapshot'
        db.create_table('webinars_gtwregistrantsnapshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webinars.Event'])),
            ('hashcode', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('webinars', ['GTWRegistrantSnapshot'])

        # Adding model 'GTWEventSnapshot'
        db.create_table('webinars_gtweventsnapshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webinars.Account'])),
            ('hashcode', self.gf('django.db.models.fields.IntegerField')()),
            ('remote_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=16383, null=True)),
            ('_time_starts_at', self.gf('sanetime.dj.SaneTimeField')(null=True)),
            ('_time_ends_at', self.gf('sanetime.dj.SaneTimeField')(null=True)),
            ('_time_started_at', self.gf('sanetime.dj.SaneTimeField')(null=True)),
            ('_time_ended_at', self.gf('sanetime.dj.SaneTimeField')(null=True)),
            ('_timezone', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
        ))
        db.send_create_signal('webinars', ['GTWEventSnapshot'])

        # Adding model 'GTWEventSyncStage'
        db.create_table('webinars_gtweventsyncstage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('webinars', ['GTWEventSyncStage'])

        # Adding model 'StagedGTWRegistrant'
        db.create_table('webinars_stagedgtwregistrant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webinars.Event'])),
            ('hashcode', self.gf('django.db.models.fields.IntegerField')()),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('started_at', self.gf('sanetime.dj.SaneTimeField')(null=True)),
            ('ended_at', self.gf('sanetime.dj.SaneTimeField')(null=True)),
            ('duration', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('webinars', ['StagedGTWRegistrant'])

        # Adding model 'StagedGTWEvent'
        db.create_table('webinars_stagedgtwevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webinars.Account'])),
            ('hashcode', self.gf('django.db.models.fields.IntegerField')()),
            ('genkey', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ...
        db.send_create_signal('webinars', ['StagedGTWEvent'])


    def backwards(self, orm):
        
        # Deleting model 'GTWRegistrantSnapshot'
        db.delete_table('webinars_gtwregistrantsnapshot')

        # Deleting model 'GTWEventSnapshot'
        db.delete_table('webinars_gtweventsnapshot')

        # Deleting model 'GTWEventSyncStage'
        db.delete_table('webinars_gtweventsyncstage')

        # Deleting model 'StagedGTWRegistrant'
        db.delete_table('webinars_stagedgtwregistrant')

        # Deleting model 'StagedGTWEvent'
        db.delete_table('webinars_stagedgtwevent')
    ...
    models = {
        ...
        'webinars.stagedgtwevent': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webinars.Account']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '16383', 'null': 'True'}),
            'genkey': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'hashcode': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
