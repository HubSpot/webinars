...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StagedWebexEvent'
        db.create_table('webinars_stagedwebexevent', (
        ...
        db.send_create_signal('webinars', ['StagedWebexEvent'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'StagedWebexEvent'
        db.delete_table('webinars_stagedwebexevent')
