...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountSyncStage.historical'
        db.add_column('webinars_accountsyncstage', 'historical', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountSyncStage.historical'
        db.delete_column('webinars_accountsyncstage', 'historical')
