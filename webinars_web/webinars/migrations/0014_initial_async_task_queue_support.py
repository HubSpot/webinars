...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('webinars_syncjob', (
            ...
            ('staged_at', self.gf('sanetime.dj.SaneTimeField')()),
            ('completed_at', self.gf('sanetime.dj.SaneTimeField')()),
        ...
        # Adding model 'StagedWebexRegistrant'
        db.create_table('webinars_stagedwebexregistrant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('webinars', ['StagedWebexRegistrant'])
        ...
        db.create_table('webinars_syncstage', (
            ...
            ('guid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webinars.CmsForm'], null=True)),
        ...
        # Adding model 'StagedHubSpotRegistrant'
        db.create_table('webinars_stagedhubspotregistrant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webinars.Event'])),
            ('recorded_at', self.gf('sanetime.dj.SaneTimeField')()),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
        ...
        db.send_create_signal('webinars', ['StagedHubSpotRegistrant'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'StagedWebexRegistrant'
        db.delete_table('webinars_stagedwebexregistrant')
        ...
        # Deleting model 'StagedHubSpotRegistrant'
        db.delete_table('webinars_stagedhubspotregistrant')
