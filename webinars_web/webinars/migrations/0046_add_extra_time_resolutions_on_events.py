...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WebexEventSnapshot._time_starts_at'
        db.add_column('webinars_webexeventsnapshot', '_time_starts_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'WebexEventSnapshot._time_ends_at'
        db.add_column('webinars_webexeventsnapshot', '_time_ends_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'WebexEventSnapshot._time_started_at'
        db.add_column('webinars_webexeventsnapshot', '_time_started_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'WebexEventSnapshot._time_ended_at'
        db.add_column('webinars_webexeventsnapshot', '_time_ended_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'WebexEventSnapshot._timezone'
        db.add_column('webinars_webexeventsnapshot', '_timezone', self.gf('django.db.models.fields.CharField')(max_length=64, null=True), keep_default=False)

        # Adding field 'Event._time_starts_at'
        db.add_column('webinars_event', '_time_starts_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'Event._time_ends_at'
        db.add_column('webinars_event', '_time_ends_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'Event._time_started_at'
        db.add_column('webinars_event', '_time_started_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'Event._time_ended_at'
        db.add_column('webinars_event', '_time_ended_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'Event._timezone'
        db.add_column('webinars_event', '_timezone', self.gf('django.db.models.fields.CharField')(max_length=64, null=True), keep_default=False)

        # Adding field 'StagedWebexEvent._time_starts_at'
        db.add_column('webinars_stagedwebexevent', '_time_starts_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'StagedWebexEvent._time_ends_at'
        db.add_column('webinars_stagedwebexevent', '_time_ends_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'StagedWebexEvent._time_started_at'
        db.add_column('webinars_stagedwebexevent', '_time_started_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'StagedWebexEvent._time_ended_at'
        db.add_column('webinars_stagedwebexevent', '_time_ended_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'StagedWebexEvent._timezone'
        db.add_column('webinars_stagedwebexevent', '_timezone', self.gf('django.db.models.fields.CharField')(max_length=64, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WebexEventSnapshot._time_starts_at'
        db.delete_column('webinars_webexeventsnapshot', '_time_starts_at')

        # Deleting field 'WebexEventSnapshot._time_ends_at'
        db.delete_column('webinars_webexeventsnapshot', '_time_ends_at')

        # Deleting field 'WebexEventSnapshot._time_started_at'
        db.delete_column('webinars_webexeventsnapshot', '_time_started_at')

        # Deleting field 'WebexEventSnapshot._time_ended_at'
        db.delete_column('webinars_webexeventsnapshot', '_time_ended_at')

        # Deleting field 'WebexEventSnapshot._timezone'
        db.delete_column('webinars_webexeventsnapshot', '_timezone')

        # Deleting field 'Event._time_starts_at'
        db.delete_column('webinars_event', '_time_starts_at')

        # Deleting field 'Event._time_ends_at'
        db.delete_column('webinars_event', '_time_ends_at')

        # Deleting field 'Event._time_started_at'
        db.delete_column('webinars_event', '_time_started_at')

        # Deleting field 'Event._time_ended_at'
        db.delete_column('webinars_event', '_time_ended_at')

        # Deleting field 'Event._timezone'
        db.delete_column('webinars_event', '_timezone')

        # Deleting field 'StagedWebexEvent._time_starts_at'
        db.delete_column('webinars_stagedwebexevent', '_time_starts_at')

        # Deleting field 'StagedWebexEvent._time_ends_at'
        db.delete_column('webinars_stagedwebexevent', '_time_ends_at')

        # Deleting field 'StagedWebexEvent._time_started_at'
        db.delete_column('webinars_stagedwebexevent', '_time_started_at')

        # Deleting field 'StagedWebexEvent._time_ended_at'
        db.delete_column('webinars_stagedwebexevent', '_time_ended_at')

        # Deleting field 'StagedWebexEvent._timezone'
        db.delete_column('webinars_stagedwebexevent', '_timezone')
