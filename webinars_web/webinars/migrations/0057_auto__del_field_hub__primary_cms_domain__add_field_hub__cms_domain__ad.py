...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Hub._primary_cms_domain'
        db.delete_column('webinars_hub', '_primary_cms_domain')

        # Adding field 'Hub._cms_domain'
        db.add_column('webinars_hub', '_cms_domain', self.gf('django.db.models.fields.CharField')(max_length=256, null=True), keep_default=False)

        # Adding field 'Hub._friends_and_family'
        db.add_column('webinars_hub', '_friends_and_family', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Hub._churned_at'
        db.add_column('webinars_hub', '_churned_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)

        # Adding field 'Hub._product_type_id'
        db.add_column('webinars_hub', '_product_type_id', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Hub._sfdc_info_at'
        db.add_column('webinars_hub', '_sfdc_info_at', self.gf('sanetime.dj.SaneTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Hub._primary_cms_domain'
        db.add_column('webinars_hub', '_primary_cms_domain', self.gf('django.db.models.fields.CharField')(max_length=256, null=True), keep_default=False)

        # Deleting field 'Hub._cms_domain'
        db.delete_column('webinars_hub', '_cms_domain')

        # Deleting field 'Hub._friends_and_family'
        db.delete_column('webinars_hub', '_friends_and_family')

        # Deleting field 'Hub._churned_at'
        db.delete_column('webinars_hub', '_churned_at')

        # Deleting field 'Hub._product_type_id'
        db.delete_column('webinars_hub', '_product_type_id')

        # Deleting field 'Hub._sfdc_info_at'
        db.delete_column('webinars_hub', '_sfdc_info_at')
    ...
    models = {
        ...
        'webinars.hub': {
            ...
            '_product_type_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
