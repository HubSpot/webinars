...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.sync_leads_for_all_time'
        db.add_column('webinars_event', 'sync_leads_for_all_time', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.sync_leads_for_all_time'
        db.delete_column('webinars_event', 'sync_leads_for_all_time')
