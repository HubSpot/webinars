...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventForm.converted_at_cutoff'
        db.add_column('webinars_eventform', 'converted_at_cutoff', self.gf('sanetime.dj.SaneTimeField')(default=0), keep_default=False)

        # Deleting field 'HubSpotEventSyncStage.cms_form'
        db.delete_column('webinars_hubspoteventsyncstage', 'cms_form_id')

        # Adding field 'HubSpotEventSyncStage.event_form'
        db.add_column('webinars_hubspoteventsyncstage', 'event_form', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['webinars.EventForm']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventForm.converted_at_cutoff'
        db.delete_column('webinars_eventform', 'converted_at_cutoff')

        # User chose to not deal with backwards NULL issues for 'HubSpotEventSyncStage.cms_form'
        raise RuntimeError("Cannot reverse this migration. 'HubSpotEventSyncStage.cms_form' and its values cannot be restored.")

        # Deleting field 'HubSpotEventSyncStage.event_form'
        db.delete_column('webinars_hubspoteventsyncstage', 'event_form_id')
