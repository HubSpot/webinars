...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Hub.timezone'
        db.delete_column('webinars_hub', 'timezone')

        # Adding field 'Hub._timezone'
        db.add_column('webinars_hub', '_timezone', self.gf('django.db.models.fields.CharField')(max_length=64, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Hub.timezone'
        db.add_column('webinars_hub', 'timezone', self.gf('django.db.models.fields.CharField')(default='America/New_York', max_length=64), keep_default=False)

        # Deleting field 'Hub._timezone'
        db.delete_column('webinars_hub', '_timezone')
