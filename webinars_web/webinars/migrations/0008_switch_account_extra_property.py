...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'Account.extra_username' to 'extra'
        db.rename_column('webinars_account', 'extra_username', 'extra')

        # Changing field 'Account.extra'
        db.alter_column('webinars_account', 'extra', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))


    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'Account.extra'
        raise RuntimeError("Cannot reverse this migration. 'Account.extra' and its values cannot be restored.")

        db.rename_column('webinars_account', 'extra', 'extra_username')
