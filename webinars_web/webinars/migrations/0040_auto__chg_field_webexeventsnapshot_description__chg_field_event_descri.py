...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webinars_webexeventsnapshot', 'description', self.gf('django.db.models.fields.CharField')(max_length=16383, null=True))

        # Changing field 'Event.description'
        db.alter_column('webinars_event', 'description', self.gf('django.db.models.fields.CharField')(max_length=16383))

        # Changing field 'StagedWebexEvent.description'
        db.alter_column('webinars_stagedwebexevent', 'description', self.gf('django.db.models.fields.CharField')(max_length=16383, null=True))


    def backwards(self, orm):
        
        # Changing field 'WebexEventSnapshot.description'
        db.alter_column('webinars_webexeventsnapshot', 'description', self.gf('django.db.models.fields.CharField')(max_length=8191, null=True))

        # Changing field 'Event.description'
        db.alter_column('webinars_event', 'description', self.gf('django.db.models.fields.CharField')(max_length=8191))

        # Changing field 'StagedWebexEvent.description'
        db.alter_column('webinars_stagedwebexevent', 'description', self.gf('django.db.models.fields.CharField')(max_length=8191, null=True))
    ...
    models = {
        ...
        'webinars.event': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '16383'}),
